...
<head>
    ...
    <title>ProjetoCRUD | Cadastrar</title>
</head>
        ...
        <form action="{{ route('users.store') }}" method="post"
            ...
            <div class="flex justify-baseline flex-col my-2">
                ...
                <input type="text" name="name" id="name" placeholder="Digite seu nome completo"
                    value="{{ old('name') }}" class="border-1 border-stone-300 p-2 rounded-sm">
            </div>
            <div class="flex justify-baseline flex-col my-2">
                <label for="email">E-mail</label>
                <input type="email" name="email" id="email" placeholder="Digite seu e-mail"
                    value="{{ old('email') }}" class="border-1 border-stone-300 p-2 rounded-sm">
            </div>
            <div class="flex justify-baseline flex-col my-2">
            ...
            <div class="flex justify-between items-center mt-3">
                ...
                <input type="submit" value="Cadastrar" class="bg-blue-800 rounded-sm p-1.5 text-stone-50">
            </div>
        </form>
    </main>
